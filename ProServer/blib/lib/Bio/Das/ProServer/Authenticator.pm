...
# Created:       2008-02-20
# Last Modified: $Date: 2009-08-27 15:25:50 +0100 (Thu, 27 Aug 2009) $ $Author: andyjenkinson $
# Id:            $Id: Authenticator.pm 587 2009-08-27 14:25:50Z andyjenkinson $
# Source:        $Source$
# $HeadURL: https://proserver.svn.sourceforge.net/svnroot/proserver/branches/1.6-spec/lib/Bio/Das/ProServer/Authenticator.pm $
#
...
our $VERSION = do { my ($v) = (q$LastChangedRevision: 587 $ =~ /\d+/mxsg); $v; };
