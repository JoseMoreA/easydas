...
# Maintainer:    jws, dj3
# Created:       2005-04-19
# Last Modified: $Date: 2009-08-13 15:01:07 +0100 (Thu, 13 Aug 2009) $ $Author: andyjenkinson $
# Id:            $Id: grouped_db.pm 586 2009-08-13 14:01:07Z andyjenkinson $
...
# $HeadURL: https://proserver.svn.sourceforge.net/svnroot/proserver/branches/1.6-spec/lib/Bio/Das/ProServer/SourceAdaptor/grouped_db.pm $
...
our $VERSION  = do { my ($v) = (q$Revision: 586 $ =~ /\d+/mxg); $v; };
