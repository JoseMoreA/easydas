...
# Created:       2009-10-21
#
# DBI-driven sourceadaptor broker. Adapted from sql for the easyDAS project. It takes the easydas_username property when returning the sources
#
...
sub sources {
  ...
  print "Asking for sources and username is: ".$self->config->{'easydas_username'}."\n";
  use Data::Dumper; print "and self id: ".Dumper($self)."\n";
  #########
